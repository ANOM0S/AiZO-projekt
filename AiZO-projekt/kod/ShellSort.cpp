...
void ShellSort::shellSort(vector<int>& data, int power, int n, int gapSelector){
    int gap;
...
// +++++++++++++++++++++++++++++++++++++++++++++++++++++ FLOAT VALUES +++++++++++++++++++++++++++++++++++++++++++++++++++
void ShellSort::sort(vector<double>& data){
   int n = data.size();

   shellSort(data, 1, n, gapSelector);
}

void ShellSort::shellSort(vector<double>& data, int power, int n, int gapSelector){
    int gap;
